...
ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.imgur.com/VZ6JaEk.jpg' : process.env.ALIVE_LOGO,
FOOTER: process.env.FOOTER === undefined ? 'ᴇᴠɪʟ-ᴘᴀꜱɪʏᴀ ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ ᴇᴠɪʟ-ᴘᴀꜱɪʏᴀ*' : process.env.CAPTION,
